...
public class Main {
	...
	public static String getRandomString()
	{
		...
		{
			int asciiCode = random.nextInt(94) + 33; //ascii codes from '!' to '~' (33-126)
			sb.append(Character.toChars(asciiCode)); //add random character to string
		}
	...
	static String sha1(String input) throws Exception 
	{
        ...
        return sb.substring(0, 1).toString(); //the second digit determines how many bites each hash will represent
    }
